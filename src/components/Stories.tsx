        ...
        >
          ...
          <Box width={'90%'}>
            ...
            <Box className="story">
                ...
                Flabrr- The Automatic Flatbread Robot (Winner TIF- 2022)
                </Text>
                <Flex>
                  <Box>
                    <Text
                      ...
                      className="text"
                    >
                      Technology and Innovation Fair, Shaastra is one of the most sought-after events for any student-run startup across the country. The plethora of opportunities it provides and opens up are innumerable and of utmost value. The mentorship provided is of great essence from the startups' point of view to analyze where they stand, what they can improve upon, and sketch their roadmap forward. The diversity of startups and their domains was impressive and one gets to learn a lot from this. Kudos to the entire team for the professional manner in which the whole show was planned and executed.
                    </Text>
                    <Text
                      fontStyle='italic'
                      fontSize='lg'
              ...
              <Box className="story">
                ...
                <Text fontSize='xl' fontWeight='bold' color='black'>
                Smart glass for visually impaired (Winner TIF- 2022)
                </Text>
                <Flex>
                  <Box>
                    <Text
                      ...
                      className="text"
                    >
                      It was a wonderful experience at TIF with the mentorship sessions and workshops. It gave us a good validation about our product and also we had new and useful insights on the business aspect of our proposed product. Once again we would like to thank the Shaastra TIF team for organizing it so well.
                    </Text>
                    <Text
                      fontStyle='italic'
                      fontSize='lg'
                      ...
                      marginRight={10}
                    >
                      -Shreesha Yajaman, Team Atmanirbhar Drishti
                    </Text>
                  </Box>
                </Flex>
              </Box>
