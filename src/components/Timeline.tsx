          ...
          <div className='steps-timeline'>
            <div className='steps-one'>
              ...
              <div className='text-ctn'>
                <p className='steps-heading'>5th November</p>
                <p className='steps-description'>TIF Launch</p>
              </div>
            </div>
            ...
            <div className='steps-two'>
              ...
              />
              <div className='text-ctn'>
                <p className='steps-heading'>25th December</p>
            ...
            <div className='steps-five'>
              ...
              />
              <div className='text-ctn'>
                <p className='steps-heading'>26-28th January</p>
            ...
            <div className='steps-six'>
              ...
              <div className='text-ctn'>
                <p className='steps-heading'>29th January</p>
