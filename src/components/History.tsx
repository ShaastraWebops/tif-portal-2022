  ...
  return (
    <React.Fragment>
      <Flex
        ...
        alignItems='center'
      >
        <Heading textColor='#ff7e20' marginTop={4} marginBottom={8}>
        ...
        >
          ...
          <Flex className='option-1'>
            ...
            >
              ...
              <Text fontSize='sm' fontWeight='bold' color='white'>
                TIF was successfully conducted as an online event. Paeticipants were invited to present their project prototypes at a project demonstration session .Online platforms were used for the finals,panel discussions, and workshops.
              </Text>
            </Flex>
          </Flex>
        </Flex>
